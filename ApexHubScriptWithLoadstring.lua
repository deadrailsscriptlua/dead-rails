...
-- Load the script from the URL using loadstring
local scriptURL = "https://raw.githubusercontent.com/deadrailsscriptlua/dead-rails/refs/heads/main/ApexHubScript.lua"
